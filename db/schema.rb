...
ActiveRecord::Schema[7.1].define(version: 2025_02_24_174913) do
  ...
  create_table "piece_lines", force: :cascade do |t|
    t.bigint "piece_id", null: false
    t.bigint "character_id", null: false
    t.bigint "line_id", null: false
    t.integer "order"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["character_id"], name: "index_piece_lines_on_character_id"
    t.index ["line_id"], name: "index_piece_lines_on_line_id"
    t.index ["piece_id", "order"], name: "index_piece_lines_on_piece_id_and_order"
    t.index ["piece_id"], name: "index_piece_lines_on_piece_id"
  end
  ...
  add_foreign_key "piece_lines", "characters"
  add_foreign_key "piece_lines", "lines"
  add_foreign_key "piece_lines", "pieces"
